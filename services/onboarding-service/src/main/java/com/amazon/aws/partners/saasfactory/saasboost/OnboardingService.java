...
//    private static final String CLOUDFRONT_DISTRIBUTION = System.getenv("CLOUDFRONT_DISTRIBUTION");
    ...
    public APIGatewayProxyResponseEvent provisionTenant(Map<String, Object> event, Context context) {
        ...
        if (requestBody.isEmpty()) {
            ...
            String opensearchCognitoUserPool = "";
            ...
            if (Utils.isNotBlank(settings.get("OPENSEARCH_ENGINE_VERSION"))){
                ...
                opensearchCognitoUserPool = settings.get("OPENSEARCH_COGNITO_USER_POOL");
                opensearchCognitoIdentityPool = settings.get("OPENSEARCH_COGNITO_IDENTITY_POOL");
            }
        ...
        // CloudFormation won't let you use dashes or underscores in Mapping second level key names
            ...
            templateParameters.add(Parameter.builder().parameterKey("OpenSearchCognitoUserPool").parameterValue(opensearchCognitoUserPool).build());
            templateParameters.add(Parameter.builder().parameterKey("OpenSearchCognitoIdentityPool").parameterValue(opensearchCognitoIdentityPool).build());
